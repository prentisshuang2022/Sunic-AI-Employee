...
const KB = [
  { icon: Zap, label: "激光设备操作", desc: "激光打标、雕刻、划片等设备操作 SOP 及安全规范", n1: 412, n2: 18, color: "primary" },
  { icon: Sun, label: "太阳能组件", desc: "组件装配 / 测试 / 串焊 / EL 检测等工艺流程", n1: 286, n2: 12, color: "warning" },
  { icon: Shield, label: "质量与合规", desc: "ISO9001 / 3A 认证 / 安全生产 / 消防应急", n1: 324, n2: 14, color: "success" },
  { icon: Globe, label: "外贸与销售", desc: "出口流程 / 产品知识 / 客户沟通话术 / 报价规则", n1: 262, n2: 9, color: "ai" },
];
            ...
            {KB.map((k) => {
              ...
              return (
                <Card
                  ...
                  onClick={() => toast.info(`已打开「${k.label}」题库`)}
                >
